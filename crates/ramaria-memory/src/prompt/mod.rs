...
/// - v2.0 提示词改造递增记录：对话主 prompt 重构——身份去助手化、社交对话基调
///   约束化、新增说话锚点、共享规则改写并接线生产路径、行为层参数改程度词、
///   `## 回复规范` 标题黏连修复，prompt 文本变更 → 旧缓存自动失效，防跨版本误命中。
pub const PROMPT_TEMPLATE_VERSION: &str = "20260912-v2.0.0";
