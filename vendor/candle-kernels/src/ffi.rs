//! vendor/candle-kernels/src/ffi.rs - Ramaria 本地补丁的 candle-kernels C FFI 绑定
//!
//! 设计特点:
//! - 声明 libmoe.a 静态库导出的 MoE（专家混合）矩阵乘 C 接口
//! - 覆盖三种调用形态：非量化 WMMA、GGUF 量化、GGUF 量化 prefill
//! - 均为 unsafe extern "C" 声明，由 candle-core 侧以 device 指针/流句柄调用
